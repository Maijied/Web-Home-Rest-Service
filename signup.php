...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    else
    {
      ...
      if ($imageExtension == "PNG" || $imageExtension == "png" || $imageExtension == "JPG" || $imageExtension == "jpg" || $imageExtension == "JPEG" || $imageExtension == "jpeg") 
      {
...
<html>
  <head>
    <title>SylRent Registration Page</title>
    <meta charset="UTF-8">
  ...
  <body>
     ...
     <div class="title"><h1>SylRent Sign Up Form</h1></div>
